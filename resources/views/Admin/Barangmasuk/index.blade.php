        ...
        <div class="card mb-4">
            <div class="card-header pb-0">
                ...
                <div data-bs-toggle="modal" data-bs-target="#tambahdata" style="float: right;">
                    <button class="btn bg-gradient-warning mb-0" href="#"> <svg xmlns="http://www.w3.org/2000/svg" width="16"
                            height="16" fill="currentColor" class="bi bi-plus-circle-dotted" viewBox="0 0 16 16">
                            <path
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nmbrgmsk"
                                            placeholder="masukkan nama barang" name="nmbrgmsk">
                                    </div>

                                    <div class="mb-3">
                                        <label for="hrgbeli" class="form-label">Harga Beli Barang Masuk</label>
                                        <input type="number" class="form-control" id="hrgbeli"
                                            placeholder="Masukkan harga beli barang" name="hrgbeli">
                                    </div>
                                    <div class="mb-3">
                                        <label for="stnbrg" class="form-label">Satuan Barang</label>
                                        <input type="text" class="form-control" id="stnbrg"
                                            placeholder="masukkan Satuan Barang" name="stnbrg">
                                    </div>
                                    <div class="mb-3">
                                        <label for="jmlhmskbrg" class="form-label">Jumlah Masuk Barang</label>
                                        <input type="number" class="form-control" id="jmlhmskbrg"
                                            placeholder="Masukkan Jumlah Masuk barang" name="jmlhmskbrg">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3" hidden="true">
                                        ...
                                        <input type="text" name="nmusr" id="nmusr" value="">
                            ...
                            <div class="modal-footer" name="tambahdata">
                                ...
                                <button type="submit" class="btn btn-primary" name="tambahdata" id="liveAlertBtn">Simpan
                                    Data</button>
                            </div>
                            </form>
                            <!-- form -->
                        ...
                        <tbody>
                            <tr scope="row">
                                ...
                                <td class="align-middle">
                                    ...
                                    <a href="../tbhstok.php?tmbbrg=id barang"
                                        class="text-secondary font-weight-bold text-xs" data-toggle="tooltip"
                                        data-original-title="tambah stok">
                                    ...
                                    <a href="../del/delmsk.php?kdbrgmsk=idbarang"
                                        class="text-secondary font-weight-bold text-xs" data-toggle="tooltip"
                                        data-original-title="del barang masuk">
